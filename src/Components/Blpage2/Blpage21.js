        ...
        <SafeAreaView style={{marginTop:StatusBar.currentHeight,flex:1}}>
            ...
            <View style={{flex:1}}>
                ...
                <View style={{flex:0.35, display:'flex' ,flexDirection:'column' ,alignItems:'center' ,justifyContent:'center',backgroundColor:'white'}}>
                        <Title style={{textTransform:'capitalize'}}>All your favorites</Title>
                        <Text style={{textAlign:'center' ,color:'#868686',fontSize:14}}>Order from the best local restaurants with easy, on-demand delivery.</Text>
