        ...
        <SafeAreaView style={{marginTop:StatusBar.currentHeight,flex:1}}>
            ...
            <View style={{flex:1}}>
                ...
                <View style={{flex:0.35, display:'flex' ,flexDirection:'column' ,alignItems:'center' ,justifyContent:'center',backgroundColor:'white'}}>
                        <Title style={{textTransform:'capitalize'}}>Free delivery offers</Title>
                        <Text style={{textAlign:'center' ,color:'#868686',fontSize:14}}>Free delivery for new customers via Apple Pay and others payment methods.</Text>
